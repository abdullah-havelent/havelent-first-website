    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-5xl">
        ...
        <motion.div
          ...
          style={{
            boxShadow: `
              0 35px 100px -35px rgba(0,0,0,0.95),
              0 0 80px -35px rgba(249,115,22,0.35),
              inset 0 1px 0 rgba(255,255,255,0.10),
              inset 0 0 60px rgba(255,255,255,0.018)
            `,
          }}
        >
          ...
          <div
            ...
            className="
              ...
              absolute
              inset-0
              bg-[radial-gradient(circle_at_65%_35%,rgba(249,115,22,0.055),transparent_42%)]
            "
          />
            ...
            <div>
              ...
              <div className="mt-8 space-y-4">
                {[
                  ...
                  {
                    icon: MapPin,
                    label: 'Based in Portugal · Serving clients worldwide',
                  },
                ].map((item) => {
