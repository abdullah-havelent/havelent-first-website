...
const PROCESS_STEPS = [
  {
    ...
    description:
      'Share your brand assets, design requirements, references, and project goals with our team. We align everything before the creative work begins.',
  },
  {
    number: '02',
    title: 'Strategy & Creative Direction',
    description:
      'We define the visual direction based on your brand, audience, and objectives, creating a clear foundation for the design before production starts.',
  },
  {
    number: '03',
    title: 'Design & Refinement',
    description:
      'Our designers develop the creative concepts and refine the selected direction through thoughtful typography, color, composition, and visual details.',
  },
  {
    number: '04',
    title: 'Final Delivery',
    description:
      'Once the design is approved, we prepare the final assets in the required formats and deliver them ready for digital platforms, marketing, or business use.',
  },
];
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-16 max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-base leading-7 text-white/50 md:text-lg">
             A clear, collaborative graphic design process designed to turn your brand
            requirements into refined, purposeful, and consistent visual design.
            </p>
          </div>
