...
const PROCESS_STEPS = [
  {
    ...
    description:
      'Share your raw footage, references, brand assets, and project requirements with our team. We make sure everything is clear before editing begins.',
  },
  {
    number: '02',
    title: 'Editing & Storytelling',
    description:
      'We shape your footage into a polished story using professional pacing, clean cuts, music, sound design, color, and visuals that keep your audience engaged.',
  },
  {
    number: '03',
    title: 'Review & Refinement',
    description:
      'You review the first version and share your feedback. We refine the edit carefully so the final result matches your vision and expectations.',
  },
  {
    number: '04',
    title: 'Final Delivery',
    description:
      'Once everything is approved, we prepare the final video in the required format and deliver it ready for publishing, marketing, or distribution.',
  },
];

export default function VideoEditingProcess() {
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-16 max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-base leading-7 text-white/50 md:text-lg">
              A simple, collaborative process designed to turn your footage
              into polished and engaging content.
            </p>
          </div>
