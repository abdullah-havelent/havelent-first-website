...
export default function About() {
  ...
  id="about"
  className="relative bg-[#000000]  px-6 py-24 sm:py-32"
>
...
>
 ...
 <h1
  className="absolute left-1/2 top-1/2 hidden -translate-x-1/2 -translate-y-1/2 select-none font-black uppercase md:block [font-family:var(--font-league-spartan)]"
 style={{
  fontSize: "20vw",
  color: "transparent",
  WebkitTextStroke: "1.5px rgba(249,115,22,0.18)",
  letterSpacing: "0.00000000000001em",
  lineHeight: 1,
  whiteSpace: "nowrap",
  zIndex: 1,
textShadow: `
