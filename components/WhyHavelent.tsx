...
const rainDrops = Array.from(
  ...
  (_, i) => {
    ...
    return {
      ...
      // Mix of near/far drops:
      // far = shorter + softer, near = longer + brighter
      depth: (i * 29) % 100,
      ...
      >
        ...
        <div
          className="
            absolute
            inset-0
            bg-[radial-gradient(circle_at_15%_35%,rgba(249,115,22,0.10),transparent_32%),radial-gradient(circle_at_85%_20%,rgba(234,88,12,0.07),transparent_32%),radial-gradient(circle_at_50%_100%,rgba(249,115,22,0.05),transparent_38%)]
          "
        />
            ...
            >
              ...
              <div
                className="
                  ...
                  transition-all
                  duration-500
                  group-hover:via-brand-orange/40
                "
              />
