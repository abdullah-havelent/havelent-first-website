...
const PROCESS_STEPS = [
  { number: '01', title: 'Discovery', description: 'We understand your business, audience, goals, and the requirements that will shape the project.' },
  { number: '02', title: 'Strategy & Structure', description: 'We plan the content structure, user journey, and page hierarchy before design work begins.' },
  { number: '03', title: 'Design', description: 'We create a modern visual direction that fits your brand and gives every page a clear purpose.' },
  { number: '04', title: 'Development', description: 'We build the responsive website with careful attention to a clean, usable final experience.' },
  { number: '05', title: 'Testing & Optimization', description: 'We check responsiveness, usability, loading performance, and key page functionality before launch.' },
  { number: '06', title: 'Launch', description: 'We prepare the website for launch and make sure the final experience feels complete and polished.' },
];
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mb-16 max-w-3xl">
              ...
              <p className="mt-6 max-w-2xl text-base leading-7 text-white/50 md:text-lg">
                A clear web development process keeps strategy, design, and delivery connected from the first conversation to launch.
              </p>
            </div>
